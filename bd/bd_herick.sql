...
--SHOW CREATE PROCEDURE  bdtlachicuates.SP_mostrar_productos_compras;
DROP PROCEDURE IF EXISTS bdtlachicuates.SP_mostrar_productos_compras;
...
WHERE estatus=1;
END
--SHOW CREATE PROCEDURE bdtlachicuates.SP_insert_pedido;

DROP PROCEDURE IF EXISTS bdtlachicuates.SP_insert_pedido;
...
END
--SHOW CREATE PROCEDURE bdtlachicuates.SP_insert_pedido_producto;
DROP PROCEDURE IF EXISTS bdtlachicuates.SP_insert_pedido_producto;
...
BEGIN
    ...
    SET var_salida = 'exito';
END
--SHOW CREATE PROCEDURE bdtlachicuates.SP_mostrar_pedidos;
DROP PROCEDURE IF EXISTS bdtlachicuates.SP_mostrar_pedidos;
